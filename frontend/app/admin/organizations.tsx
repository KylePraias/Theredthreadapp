...
// Use UserResponse type directly instead of a separate Organization interface
type Organization = UserResponse;

export default function OrganizationApprovalsScreen() {
